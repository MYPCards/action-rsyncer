...
LABEL version="3.0.0"
LABEL maintainer="MYPCards Tech Team <tech@MYPCards.com>" \
      org.label-schema.vendor="MYPCards GmbH" \
...
RUN apk add --no-cache --virtual .run-deps rsync=3.2.7-r4 openssh=9.3_p2-r0 && \
    rm -rf /var/cache/apk/*
